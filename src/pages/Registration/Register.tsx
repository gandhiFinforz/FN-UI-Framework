...
const Register: React.FC = () => {
  ...
  return (
   <div className='row flex-none md:flex h-screen '>
       <div className="sm:col-12 md:col-6 theme-clr md:block hidden ">
        <div className='align-items-center flex h-screen justify-content-center'>
        
        <div>
        <h2 className="text-center text-white">Start Your Step {currentStep + 1}</h2>
       ...
       <div className='sm:col-12 md:col-6 align-items-center flex h-screen justify-content-center'>
