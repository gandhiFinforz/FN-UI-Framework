        ...
        <div className="col-12 md:col-6 lg:col-3">
          <div className="surface-0 shadow-2 p-3 border-1 border-50 border-round">
            <div className="flex justify-content-between mb-3">
              ...
              <div className="flex align-items-center justify-content-center bg-blue-100 border-round w-2">
        ...
        <div className="col-12 md:col-6 lg:col-3">
          <div className="surface-0 shadow-2 p-3 border-1 border-50 border-round">
            <div className="flex justify-content-between mb-3">
              ...
              <div className="flex align-items-center justify-content-center bg-orange-100 border-round w-2">
        ...
        <div className="col-12 md:col-6 lg:col-3">
          <div className="surface-0 shadow-2 p-3 border-1 border-50 border-round">
            <div className="flex justify-content-between mb-3">
              ...
              <div className="flex align-items-center justify-content-center bg-cyan-100 border-round w-2">
        ...
        <div className="col-12 md:col-6 lg:col-3">
          <div className="surface-0 shadow-2 p-3 border-1 border-50 border-round">
            <div className="flex justify-content-between mb-3">
              ...
              <div className="flex align-items-center justify-content-center bg-purple-100 border-round w-2">
