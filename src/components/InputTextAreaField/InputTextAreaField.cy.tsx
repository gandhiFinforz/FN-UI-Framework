...
describe('<TextAreaField />', () => {
  ...
  it('displays the correct value', () => {
    ...
    mount(<TextAreaField value={value} id="textarea" label="Label for textarea" name={''} />);
  ...
  it('calls onChange when value changes', () => {
    ...
    mount(<TextAreaField id="textarea" label="Label for textarea" onChange={handleChange} name={''} />);
  ...
  it('is disabled when disabled prop is true', () => {
    mount(<TextAreaField id="textarea" label="Label for textarea" disabled name={''} />);
    cy.get('textarea#textarea').should('be.disabled');
    cy.screenshot('component/TextAreaField/is disabled when disabled prop is true');
  });

//   it('applies invalid state when invalid prop is true', () => {
//     mount(<TextAreaField id="textarea" label="Label for textarea" invalid name={''} />);
//     cy.get('textarea#textarea').should('have.class', 'p-invalid');
//     cy.screenshot('component/TextAreaField/applies invalid state when invalid prop is true');
//   });

  it('applies custom class name', () => {
    const className = 'custom-textarea';
    mount(<TextAreaField id="textarea" label="Label for textarea" className={className} name={''} />);
  ...
  it('renders with specified size', () => {
    mount(<TextAreaField id="textarea" label="Label for textarea" size="lg" name={''} />);
  ...
  it('applies unstyled when unstyled prop is true', () => {
    mount(<TextAreaField id="textarea" label="Label for textarea" unstyled name={''} />);
    cy.get('textarea#textarea').should('not.have.class', 'p-inputtext');
    cy.screenshot('component/TextAreaField/applies unstyled when unstyled prop is true');
  });
});
