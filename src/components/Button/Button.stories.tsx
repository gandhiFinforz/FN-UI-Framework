...
export default {
  ...
  argTypes: {
    ...
    badgeClassName: { control: 'text', description: 'Style class of the badge.' },
    ...
    loading: { control: 'boolean', description: 'Display loading icon of the button.' },
    loadingIcon: { control: 'text', description: 'Name of the loading icon or JSX.Element for loading icon.' },
    ...
    pt: { control: 'object', description: 'Uses to pass attributes to DOM elements inside the component.' },
    ptOptions: { control: 'object', description: 'Used to configure passthrough options of the component.' },
    ...
    severity: {
      control: { type: 'select', options: ['success', 'help', 'warning', 'secondary', 'info', 'danger'] },
      description: 'Defines the style of the button.',
    },
    size: { control: { type: 'select', options: ['small', 'large'] }, description: 'Defines the size of the button.' },
    ...
    tooltipOptions: { control: 'object', description: 'Configuration of the tooltip.' },
    unstyled: { control: 'boolean', description: 'When enabled, it removes component related styles in the core.' },
    visible: { control: 'boolean', description: 'When present, it specifies that the element should be visible.' },
  },
} as Meta;
